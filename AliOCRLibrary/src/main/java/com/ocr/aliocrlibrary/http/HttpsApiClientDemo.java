...
public class HttpsApiClientDemo extends HttpApiClient{
    public final static String HOST = "dm-51.data.aliyun.com";
    static HttpsApiClientDemo instance = new HttpsApiClientDemo();
    public static HttpsApiClientDemo getInstance(){return instance;}
